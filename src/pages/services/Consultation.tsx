...
export default function Consultation() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Biznes moliyaviy holatini yaxshilash bo'yicha maslahatlar",
      price: "400,000",
      hourly: true,
      features: [
        "Moliyaviy tahlil",
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          <h1 className="text-3xl font-bold mb-4">Konsultatsiyalar</h1>
          <p className="text-lg text-gray-600">
            Biznesingiz uchun professional maslahat xizmatlari
          </p>
        </div>
              ...
              <CardHeader className="pb-4">
                <div className="flex justify-between items-center">
                  <div className="bg-accountblue-50 p-2 rounded-md">
                    <HelpCircle className="text-accountblue-600 h-5 w-5" />
                  </div>
                </div>
